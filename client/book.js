...
var App = React.createClass({
    render: function() {
        return (
          <div>
            <div className="col-xs-10 col-md-10 col-sm-10" id="bookDetails">
              <h4 id="bookName">A Line in the Sand: The Battle to Integrate the Nantucket Public Schools 1825-1847</h4>
                <p>A monumental struggle for equal rights took place on Nantucket in the 1840s. On one side were 
            ...
            <div className="col-xs-10 col-md-10 col-sm-10" id="bookDetails">
              <h4 id="bookName">Live to the Truth: The Life and Times of Cyrus Peirce: Crusader for 
              American Public Education Founder of the First Public Teacher-Training School in the Nation</h4>
              <p>This is a biography of Cyrus Peirce who was the founder of the first public teacher training school 
              ...
              fight to desegregate Nantucket's public schools which led to the passage of the earliest civil rights law to guarantee equal access
            ...
            <div className="col-xs-4 col-md-3 col-sm-8" id="bookDetails">
              <h4 id="bookName">Line In the Sand</h4> 
            </div>
          </div>
        );
    }
